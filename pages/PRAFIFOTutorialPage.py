...
from resource_path import load_json_resource  # Resource helper (PyInstaller-safe)
...
class PRAFIFOTutorialPage(QWidget):
    ...
    def _load_step_templates(self):
        ...
        templates = load_json_resource('tutorial_kb/pra_fifo_steps.json', default=None)
    ...
    def _generate_steps(self):
        ...
        for col_idx, requested_page in enumerate(self.page_sequence):
            ...
            if requested_page in pages_in_memory:
                ...
                # FIFO: queue order does NOT change on hit
                ...
                # FAULT - replace oldest frame (front of queue)
                page_faults += 1
                victim_frame = current_queue[0]  # Oldest is first
                ...
                # Update queue: remove victim from front, add to back
                current_queue.pop(0)
