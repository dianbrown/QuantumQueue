...
### Fixed
- Fixed missing/incorrect tutorial step descriptions in the packaged Windows exe
  - Bundled `tutorial_kb/` JSON files into the PyInstaller build
  - Updated tutorial pages to load step templates via a PyInstaller-safe resource loader
